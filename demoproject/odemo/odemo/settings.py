...
BUILDOUTDIR = os.path.dirname(os.path.dirname(PROJECTDIR))
projectdir = lambda p: os.path.join(PROJECTDIR, p)
buildoutdir = lambda p: os.path.join(BUILDOUTDIR, p)
...
STATIC_ROOT = buildoutdir('static')
