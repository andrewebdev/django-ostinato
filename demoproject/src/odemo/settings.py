...
SECRET_KEY = '^xppf+b%+o-x*dh7!t=6=q!+mg^0ch&amp;#phfxx=olh)xd-2vlni'
...
OSTINATO_PAGE_TEMPLATES = ({
    ...
    # 'template': 'page_templates/basic_page.html',
    'zones': (
        ('meta', 'pages.pagemeta'),
    ...
    # 'template': 'page_templates/landing_page.html',
    'zones': (
