    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('private', 'Private'), ('public', 'Public')], default='public', max_length=20, verbose_name='State')),
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='page_children', to='ostinato_pages.Page', verbose_name='Parent')),
            ],
            options={
                'verbose_name': 'Page',
