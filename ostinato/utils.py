...
class Emailer(object):
    ...
    writing for almost every project, some sites even with multiple different
    kinds of email requirements.

    We mainly use this internally, but feel free to use if you want to.
    """
